...
/**
 * Mapper for Election entity.
 * Converts between Election domain model and ElectionEntity, including
 * candidate mapping.
 */
@Component
@RequiredArgsConstructor
public class ElectionEntityMapper {
    private final CandidateEntityMapper candidateEntityMapper;

    /**
     * Converts ElectionEntity to Election domain model.
     *
     * @param entity The ElectionEntity.
    ...
    /**
     * Converts Election domain model to ElectionEntity.
     *
     * @param domain The Election domain model.
     * @return The ElectionEntity.
     */
        ...
        if (domain.getCandidates() != null && !domain.getCandidates().isEmpty()) {
            entity.setCandidates(
                    domain.getCandidates().stream()
                            .map(candidateEntityMapper::toEntity)
